...
import static io.github.thecsdev.examplemod.ExampleMod.getModID;
...
/**
 * A default config {@link File} for {@link ExampleMod}.<br/>
 * @apiNote This mod's developer may add their own custom config properties for this mod here.
 */
public final class ExampleModConfig extends AutoConfig
{
	// ==================================================
	/* 
	...
	// ==================================================
	public ExampleModConfig() throws InvalidPathException { super(getModID()); }
	// ==================================================
}